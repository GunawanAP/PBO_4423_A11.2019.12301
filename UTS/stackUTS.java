...
public class stackUTS {
    ...
    public String convStrToStack(String inputan){
        ...
        if (index == -1 || index2 == -1){
            System.out.println(inputan + " merupakan persamaan yang tidak valid");
            cekInputan = "x";
        }
        String p = "+";
        ...
        for (int i = 0; i < inputan.length(); i ++){
            if (inputan.charAt(i) != plus){
                this.stackNO.push(inputan.charAt(i));
    ...
    public void cekInput(Stack stack,String inputan){
        ...
        for (int j = 0; j < stackNO.size();j++){
            ...
            if (kiri.peek() == equal){
                ...
                counter ++;
                if (counter == 2) {
                    System.out.println(inputan + " tidak valid karena hanya satu "=" yang diijinkan.");
                    cek = "s";
                    break;
                }
            }
